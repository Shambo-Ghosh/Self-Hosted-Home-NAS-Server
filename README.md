...
The full setup is documented in [`NAS_Project_Documentation_Algorithm v1.2.pdf`](./NAS_Project_Documentation_Algorithm v1.2 (2).pdf), but here's the high-level order:
...
📄 [`NAS_Project_Documentation_Algorithm v1.2.pdf`](./NAS_Project_Documentation_Algorithm v1.2 (2).pdf)
